...
from Naked.toolshed.types import XString, XDict, XList, XSet, XFSet, XTuple
from Naked.toolshed.casts import xstr, xd, xl, xq, xset, xfset, xt
...
class NakedCastsTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_xstring = xstr(self.teststring)
        self.test_xdict = xd(self.testdict)
        self.test_xlist = xl(self.testlist)
        self.test_xset = xset(self.testset)
        self.test_xfset = xfset(self.frozenset)
        self.test_xtuple = xt(self.testtuple)
    ...
    #------------------------------------------------------------------------------
    # TODO: confirm that the cast appropriately assigned attributes
    #------------------------------------------------------------------------------
